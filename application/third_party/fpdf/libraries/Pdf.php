...
// Tableau simple
function BasicTable($data)// $data from controller 
 {
//  header of table 
        // $this->SetFont('Times','B',12);
        // $this->Cell(40,7,"nom",1,0,'C');
        // $this->Cell(40,7,"prenom",1,0,'C');
        // $this->Cell(40,7,"date",1,0,'C');
        // $this->Cell(50,7,"email",1,0,'C');
        //  $this->Ln();

    //    $this->Cell(40,7,$data,1,0,'C');

       $this->MultiCell(300, 10, $data, 1);


    // Données la meme chose pour les donnees 
    // foreach($data as $row)
    // {

    //     $this->SetFont('Times','',10);
    //     $this->Cell(40,6,$row->first_name,1);
    //     $this->Cell(40,6,$row->last_name,1);
    //     $this->Cell(40,6,$row->birthdate,1);
